...
const projectsArray = [
    { 
        ...
        img: project1, 
        name: "PlatziTravel", 
        desc: "PlatziTravel is a web application focused on travel planning, allowing users to search for and locate vacation rentals and personalized destinations through smart filters, dynamic search tools, and interactive maps. The project features a modern interface with sections such as a carousel of recommended destinations, a grid of featured rentals, and a login system to access user profiles and manage reservations. With a strong emphasis on UX/UI, PlatziTravel offers an intuitive, visually appealing, and functional experience to help users organize their trips from any device.",
