...
function Contact() {
    ...
    return(
        <footer id='contact' className="snap-section bg-whitebg text-blackbg w-full flex flex-col gap-10 items-center justify-center p-20">
            <h1 className="text-6xl font-bold bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 text-transparent bg-clip-text">{animatedTitle}</h1>
